...
recognition.addEventListener("result", e => {
  ...
  if (e.results[0].isFinal) {
    //const buttonList = $('<div>').append('<button type="button" class="list-group-item list-group-item-action>a</button>')
    
    $('#wordsContainer').append(`<button type="button" class="list-group-item list-group-item-action"><input name="checklist[]" type="text" class="form-control-plaintext" value="${transcript}"></button>`);  
    //'#wordsContainer').append(buttonList);
  }
